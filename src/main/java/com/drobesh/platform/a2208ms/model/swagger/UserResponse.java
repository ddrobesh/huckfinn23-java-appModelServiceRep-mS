package com.drobesh.platform.a2208ms.model.swagger;
...
/**
 * Swagger resonse REST API class for TheUserModel object
 * 
 * @author drobeshfamily
 * @param <T>
 */
public class UserResponse<T> extends Resource<TheModelUser> {

  public UserResponse(TheModelUser content) {
	  super(content);
  }

  @Override
  public TheModelUser getContent() {
